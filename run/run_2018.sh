...
#python python/SKFlat.py -a GetEffLumi -l ./run/MC_signal_2018.txt -y 2018 -q fastq -n 1 &
...
python python/SKFlat.py -a HN_pair_all -l ./run/WJets_MG_HT.txt  --skim SkimTree_LRSMHighPt -y 2018 -q fastq -n 10 &
