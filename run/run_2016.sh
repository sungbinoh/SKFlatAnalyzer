...
###############
#MC
python python/SKFlat.py -a HN_pair_all -l ./run/MC_DY_HT_binned.txt --skim SkimTree_LRSMHighPt -y 2016 -q fastq -n 20 &
python python/SKFlat.py -a HN_pair_all -l ./run/MC_big_2016.txt --skim SkimTree_LRSMHighPt -y 2016 -q fastq -n 20 &
python python/SKFlat.py -a HN_pair_all -l ./run/MC_small_2018.txt --skim SkimTree_LRSMHighPt -y 2016 -q fastq -n 20 &
python python/SKFlat.py -a HN_pair_all -l ./run/MC_minor_2016.txt --skim SkimTree_LRSMHighPt -y 2016 -q fastq -n 20 &
