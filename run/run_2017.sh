...
###############
#MC
#python python/SKFlat.py -a HN_pair_all -l ./run/MC_DY_HT.txt  --skim SkimTree_LRSMHighPt -y 2017 -q fastq -n 30 &
#python python/SKFlat.py -a HN_pair_all -l ./run/MC_big_2017.txt --skim SkimTree_LRSMHighPt -y 2017 -q fastq -n 30 &
#python python/SKFlat.py -a HN_pair_all -l ./run/MC_small_2018.txt --skim SkimTree_LRSMHighPt -y 2017 -q fastq -n 30 &
#python python/SKFlat.py -a HN_pair_all -l ./run/MC_minor_2018.txt --skim SkimTree_LRSMHighPt -y 2017 -q fastq -n 30 &
