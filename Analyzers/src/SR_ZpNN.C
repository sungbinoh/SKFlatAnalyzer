...
void SR_ZpNN::executeEventFromParameter(AnalyzerParameter param, std::vector<Electron> electron_all, std::vector<Muon> muons_all, std::vector<Jet> jets_all, std::vector<FatJet> fatjets_all, TString syst_flag, double PDF_weight){
  ...
  */
  ...
  SR(param, current_channel + "DYreweight_" + syst_flag, trig_pass_for_channel,  current_weight * prefire_weight, jets, fatjets, electrons_Tight_all, electrons_Loose, muons_Tight_all, muons_Loose, N_electrons_Tight_all, N_electrons_Loose, N_muons_Tight_all, N_muons_Loose);
  SR(param, current_channel + "DYreweight_NoPFweight" + syst_flag, trig_pass_for_channel,  current_weight, jets, fatjets, electrons_Tight_all, electrons_Loose, muons_Tight_all, muons_Loose, N_electrons_Tight_all, N_electrons_Loose, N_muons_Tight_all, N_muons_Loose);
