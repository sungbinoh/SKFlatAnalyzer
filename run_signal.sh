...
#python python/SKFlat.py -a SR_ZpNN -l ./run/MC_signal_2016.txt -y 2017 -q fastq --batchname ZpNN_signal_2017 -n 1 &
python python/SKFlat.py -a SR_ZpNN -l ./run/MC_signal_2016.txt -y 2018 -q fastq --batchname ZpNN_signal_2018 -n 1 &

#python python/SKFlat.py -a SR_ZpNN -y 2017 -i HNPairToJJJJ_MuMu_ZP4600_N1000_WR5000  -q fastq --batchname HNPairToJJJJ_MuMu_ZP4600_N1000_WR5000_2017 -n 1 &
